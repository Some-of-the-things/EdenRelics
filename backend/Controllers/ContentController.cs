...
public class ContentController(EdenRelicsDbContext context) : ControllerBase
{
    ...
    private static readonly Dictionary<string, string> Defaults = new()
    {
        ...
        ["policy.privacy.content"] = """
            ...
            <div class="policy__section"><h2>2. Data Controller</h2><p>The data controller is DCPNET LTD, Company No. 15734157, registered at 30 Vane Close, Norwich, NR7 0US, United Kingdom. For data protection enquiries, contact us at edenrelics&#64;dcp-net.com.</p></div>
            ...
            <div class="policy__section"><h2>12. Contact</h2><p>For data protection enquiries, contact DCPNET LTD at edenrelics&#64;dcp-net.com or by post at 30 Vane Close, Norwich, NR7 0US, United Kingdom.</p></div>
            """,
        ...
        ["policy.returns.content"] = """
            ...
            <div class="policy__section"><h2>10. Contact Us</h2><p>If you have any questions about our returns policy, please contact us at edenrelics&#64;dcp-net.com or by post at DCPNET LTD, 30 Vane Close, Norwich, NR7 0US, United Kingdom.</p></div>
            """,

        ["policy.supply-chain.updated"] = "March 2026",
        ["policy.supply-chain.content"] = """
            <div class="policy__section"><h2>1. Introduction</h2><p>DCPNET LTD is committed to responsible and ethical sourcing across our entire supply chain. This policy outlines our standards and expectations for all suppliers and partners.</p></div>
        ...
        ["policy.modern-slavery.content"] = """
            <div class="policy__section"><h2>1. Introduction</h2><p>DCPNET LTD is committed to preventing modern slavery and human trafficking in all aspects of our business and supply chain. This statement is made pursuant to Section 54 of the Modern Slavery Act 2015.</p></div>
            <div class="policy__section"><h2>2. Our Business</h2><p>DCPNET LTD operates as a vintage clothing retailer, sourcing carefully curated garments from a variety of suppliers and sellers across multiple regions.</p></div>
        ...
        ["policy.terms.content"] = """
            ...
            <div class="policy__section"><h2>2. Products &amp; Pricing</h2><p>All items sold through Eden Relics are vintage, pre-owned garments. Each item is unique and one-of-a-kind. We take great care to accurately describe and photograph every item, including noting any signs of wear or imperfections. All prices displayed on the website are in pounds sterling (GBP) and are inclusive of VAT where applicable. We reserve the right to amend prices at any time, but changes will not affect orders already confirmed.</p></div>
            ...
            <div class="policy__section"><h2>13. Contact Us</h2><p>DCPNET LTD, 30 Vane Close, Norwich, NR7 0US, United Kingdom. Email: edenrelics&#64;dcp-net.com. Phone: +44 (0) 7454 705183.</p></div>
            """,
        ...
        ["report.compliance.content"] = """
            ...
            <div class="policy__section"><h2>3. Consumer Protection</h2><p><strong>Status: Compliant.</strong> A detailed returns policy is in place with the 14-day cooling-off period. Right-of-withdrawal is shown at checkout. VAT-inclusive pricing is clearly stated. Comprehensive Terms &amp; Conditions have been published.</p></div>
            ...
            <div class="policy__section"><h2>5. Accessibility</h2><p><strong>Status: Substantially compliant with ongoing improvements.</strong> An independent WCAG 2.1 Level AA audit returned zero automated errors. A small number of manual review findings remain open and are being addressed.</p></div>
        ...
        ["policy.cookies.content"] = """
            ...
            <div class="policy__section"><h2>8. Contact Us</h2><p>If you have questions about our use of cookies, please contact us at edenrelics&#64;dcp-net.com or by post at DCPNET LTD, 30 Vane Close, Norwich, NR7 0US, United Kingdom.</p></div>
            """,
    };
}
