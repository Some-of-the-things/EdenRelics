...
public static class Helpers
{
    ...
    public record ProductResponse(Guid Id, string Name, string Description, decimal Price, string Era, string Category, string Size, string Condition, string ImageUrl, bool InStock);
