...
public class ShippingTests : IClassFixture<ApiFactory>
{
    ...
    public async Task GetCountries_ReturnsAllZones()
    {
        ...
        var response = await client.GetAsync("/api/shipping/countries");
    ...
    {
        var client = _factory.CreateClient();
        var json = await client.GetStringAsync("/api/shipping/countries");
    ...
    {
        var client = _factory.CreateClient();
        var rate = await client.GetFromJsonAsync<ShippingRateResponse>("/api/shipping/rate?country=GB", JsonOptions);
        Assert.NotNull(rate);
    ...
    {
        var client = _factory.CreateClient();
        var rate = await client.GetFromJsonAsync<ShippingRateResponse>("/api/shipping/rate?country=France", JsonOptions);
        Assert.NotNull(rate);
    ...
    {
        var client = _factory.CreateClient();
        var rate = await client.GetFromJsonAsync<ShippingRateResponse>("/api/shipping/rate?country=US", JsonOptions);
        Assert.NotNull(rate);
    ...
    {
        var client = _factory.CreateClient();
        var rate = await client.GetFromJsonAsync<ShippingRateResponse>("/api/shipping/rate?country=AU", JsonOptions);
        Assert.NotNull(rate);
    ...
    {
        var client = _factory.CreateClient();
        var rate = await client.GetFromJsonAsync<ShippingRateResponse>("/api/shipping/rate?country=JP", JsonOptions);
        Assert.NotNull(rate);
        Assert.Equal(14.95m, rate.Price);
    }
    ...
    {
        var client = _factory.CreateClient();
        var rate = await client.GetFromJsonAsync<ShippingRateResponse>("/api/shipping/rate?country=ZA", JsonOptions);
        Assert.NotNull(rate);
    ...
    {
        var client = _factory.CreateClient();
        var response = await client.GetAsync("/api/shipping/rate?country=XX");
    ...
    {
        var client = _factory.CreateClient();
        var response = await client.GetAsync("/api/shipping/rate?country=");
        Assert.Equal(HttpStatusCode.BadRequest, response.StatusCode);
    }
    ...
    {
        var client = _factory.CreateClient();
        var response = await client.GetAsync("/api/shipping/rate");
        Assert.Equal(HttpStatusCode.BadRequest, response.StatusCode);
    }
