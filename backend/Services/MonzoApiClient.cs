...
// Thin wrapper over the Monzo REST API. Stateless — holds no persistence concerns.
// Token storage/refresh and transaction sync live in MonzoService (the orchestration layer).
public class MonzoApiClient(
    HttpClient httpClient,
    IConfiguration configuration,
    ILogger<MonzoApiClient> logger)
{
