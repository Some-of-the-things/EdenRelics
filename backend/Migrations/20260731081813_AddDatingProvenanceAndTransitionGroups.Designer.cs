...
namespace Eden_Relics_BE.Migrations
{
    ...
    [Migration("20260731081813_AddDatingProvenanceAndTransitionGroups")]
    partial class AddDatingProvenanceAndTransitionGroups
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.CareFabric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("HowToIdentify")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("VintageCautions")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.CareIssue", b =>
                {
                    ...
                    b.Property<string>("GeneralMethod")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("WhenToSeeAPro")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("CareIssues");
                });

            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.DatingAssessment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("ContradictsClaimedEra")
                        .HasColumnType("boolean");

                    b.Property<DateTime>("CreatedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateOnly?>("Earliest")
                        .HasColumnType("date");

                    b.Property<Guid>("GarmentId")
                        .HasColumnType("uuid");

                    b.Property<bool>("HasHardContradiction")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasSoftContradiction")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean");

                    b.Property<DateOnly?>("Latest")
                        .HasColumnType("date");
                    ...
                    b.ToTable("DatingAssessments");
                });

            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.DatingAssessmentStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AppliedToInterval")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateOnly>("EffectiveBoundDate")
                        .HasColumnType("date");
                    ...
                    b.Property<string>("EvidenceValue")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<int>("ToleranceMonthsApplied")
                        .HasColumnType("integer");

                    b.Property<string>("TransitionGroupCode")
                        .HasColumnType("text");
                    ...
                    b.ToTable("DatingAssessmentSteps");
                });

            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.DatingRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("TrailingToleranceMonths")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Status", "EvidenceType");

                    b.ToTable("DatingRules");
                });

            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.DatingTransitionGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DatingTransitionGroups");
                });
            ...
            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.Garment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateOnly?>("ClaimedEraEnd")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("ClaimedEraStart")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.TopPick", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eden_Relics_BE.Data.Entities.DatingAssessmentStep", b =>
                {
                    b.HasOne("Eden_Relics_BE.Data.Entities.DatingAssessment", "Assessment")
                        .WithMany("Steps")
