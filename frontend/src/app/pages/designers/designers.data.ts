...
export const DESIGNERS: DesignerProfile[] = [
  ...
  },
  {
    ...
    intro: 'Carole Little\'s Los Angeles label became closely associated with the rayon floral maxi dress — relaxed, drapey, hand-painted-look prints with a California-meets-bohemian elegance.',
    history: [
      'Carole Little and her husband Leonard Goldstein founded the label in Los Angeles in 1975, and through the 1980s and 90s it grew into one of America\'s better-known contemporary brands — associated with relaxed silhouettes, artisanal prints, and saturated colours.',
      'The label is best known for the rayon floral midi and maxi dress: open backs, soft shoulders, side pockets, and prints that ranged from inky florals to abstract botanicals. These are valued on the resale market for their drape and distinctive prints.',
      'Carole Little Inc. ceased operations in 2003, which means every genuine piece is at least two decades old. The brand has not been revived under the same ownership, so all genuine Carole Little is vintage.',
    ],
    identificationHeading: 'How to recognise vintage Carole Little',
    identification: [
      'Look for a white woven label reading "Carole Little" in a flowing italic script, often with "Saint-Tropez West" or "for Saint-Tropez West" underneath on earlier 80s pieces — the sub-label wording is a useful dating clue.',
      'Fabric is very often rayon or a rayon/silk blend — soft, slightly slubbed, and drapey — but read it as era-typical context rather than an authenticity test, since not every genuine piece is rayon.',
