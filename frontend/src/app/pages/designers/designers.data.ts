...
export const DESIGNERS: DesignerProfile[] = [
  {
    ...
    intro: 'Leslie Fay was one of America\'s biggest mid-market dress makers — for a time the second-largest supplier of women\'s clothing to US department stores. Its moderately priced, conservative day and occasion dresses filled 1980s and 90s wardrobes, and original pieces are collected today for their era-typical cut and department-store construction rather than any single signature look.',
    history: [
      'Leslie Fay was founded in New York in 1947 by Fred Pomerantz, who had made dresses for the Women\'s Army Corps during the war and named the company after his daughter. It grew into a major mass-market manufacturer of moderately priced women\'s clothing — mainly dresses, careerwear and occasionwear — sold through department and specialty stores across the United States rather than as a high-fashion design house.',
      'Its strongest years were the 1980s to early 1990s. By 1990 sales had reached around $859 million — roughly triple a decade earlier — making it one of the largest suppliers of women\'s clothing to American department stores, operating a family of labels and licences alongside the core Leslie Fay name.',
      'In 1993 the company disclosed a major accounting fraud and filed for Chapter 11 soon after, bringing heavy losses, closures and layoffs; it later restructured and continued in a much-reduced form. For collectors this makes the peak-era pieces — broadly pre-mid-1990s — the ones most associated with the label.',
    ],
    identificationHeading: 'How to recognise Leslie Fay dresses',
    identification: [
      'Start with the woven "Leslie Fay" label. Its design changed over the decades and across the company\'s many sub-labels, so it confirms the brand — but there is no dependable serif-versus-block rule that pins a piece to an exact era on its own.',
      ...
      'Read the construction as era context. Structured tailoring, fabric-covered shoulder pads, interior waist tapes and "Made in USA" or "Made in Hong Kong" union labels are typical of the period — but they are shared across many department-store brands, so they date a piece rather than prove the label.',
