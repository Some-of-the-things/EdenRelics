...
export const DESIGNERS: DesignerProfile[] = [
  {
    slug: 'leslie-fay',
    name: 'Leslie Fay',
    metaTitle: 'Vintage Leslie Fay Dresses — 1980s & 1990s American',
    metaDescription: 'Vintage Leslie Fay dresses — the moderately priced American department-store label of the 1980s and 90s. Structured day and occasion dresses, hand-picked and inspected.',
    origin: 'New York, USA — founded 1947',
    intro: 'Leslie Fay was one of America\'s big mid-market dress houses — a mass-market maker of moderately priced, stylishly conservative womenswear rather than a high-fashion design label. Its day and occasion dresses filled 1980s and 90s department stores, and original pieces are collected today for their era-typical cut and department-store construction rather than for any single signature look.',
    history: [
      'Leslie Fay was founded in 1947 by Fred Pomerantz, who had made dresses for the Women\'s Army Corps during the war and named the company after his daughter. It grew into a major manufacturer of moderately priced women\'s clothing — mainly dresses, careerwear and occasionwear — sold through department and specialty stores across the United States, and is credited with helping to pioneer the "petite" sizing category in American womenswear.',
      'Its strongest years were the 1980s to the early 1990s. By 1990 sales had reached around $858 million, making it one of the largest suppliers of moderately priced women\'s clothing to American department stores, with a family of sub-labels and licences alongside the core Leslie Fay name.',
      'In 1993 the company disclosed a major accounting fraud — chiefly an overstatement of the garments it had produced — and filed for Chapter 11 soon after, bringing heavy losses, closures and layoffs before it emerged and continued in a much-reduced form. For collectors this makes the peak-era pieces, broadly pre-mid-1990s, the ones most associated with the label.',
    ],
    identificationHeading: 'How to recognise vintage Leslie Fay',
    identification: [
      'Start with the woven "Leslie Fay" label, and read the size label too — the company was known for petite sizing, so a petite mark is era-typical. The label design changed across the decades and the company\'s many sub-labels, so it confirms the brand but no single version pins a piece to an exact year on its own.',
      'Expect era-typical fabrics, not a signature cloth. Peak-era Leslie Fay used polyester, acetate, rayon and mixed synthetic blends widely — so fabric helps place the era but does not authenticate the brand, and rayon is not a mark of a "genuine" piece.',
      'Read the construction and prints as era context. Structured, office-appropriate tailoring, covered shoulder pads and seasonal prints — florals, geometrics and novelty patterns — are typical of the period, but they are shared across many department-store brands, so they date a piece rather than prove the label.',
      'Recognise it by triangulation, not a signature. Because Leslie Fay was a mass-market house, no single print or silhouette — not polka dots, not peplums — is brand-defining; read the label, the sizing, the construction and the overall 1980s–90s department-store styling together rather than relying on any one "tell".',
    ],
  ...
  },
  {
    ...
    metaDescription: 'Vintage Carole Little — the Los Angeles label known for rayon florals, soft draped silhouettes and bold, painterly prints. One-of-a-kind pieces, hand-inspected, UK shipping.',
    origin: 'Los Angeles, USA — founded mid-1970s',
    intro: 'Carole Little\'s Los Angeles label became closely associated with soft, draped rayon dresses in bold floral and painterly abstract prints — an accessible, California-meets-bohemian take on contemporary womenswear.',
    history: [
      'Carole Little founded the Los Angeles label in the mid-1970s with her business partner Leonard Rabinowitz, and through the 1980s and 90s it grew into a well-known American contemporary womenswear brand — associated with relaxed silhouettes, bold prints, and saturated colours, sold largely through US department stores.',
      'The label is best known for soft, draped dresses and separates — flowing rayon midi and maxi styles in bold florals and painterly abstract prints. On the resale market today they are valued mainly for their prints and drape rather than for a famous name or high monetary value.',
      'The original Carole Little company ran into financial trouble in the early 2000s; its trademarks were acquired out of bankruptcy by Cherokee Inc. in 2002 and have been licensed to other retailers since, so no continuous original design house survives. Original-era pieces from the 1980s and 90s are the collectable vintage ones — but because the name later continued under licence, not every garment labelled "Carole Little" is old.',
    ],
    identificationHeading: 'How to recognise vintage Carole Little',
    identification: [
      'Look for a woven or printed "Carole Little" label. Some pieces also carry the "Saint-Tropez West" sub-label — an early Carole Little line — so its presence tends to point to an earlier piece, though treat it as a soft hint rather than a precise date.',
      'Rayon appears frequently, but so do blends — rayon/silk, rayon/polyester and other lightweight draping fabrics. Read the fibre content as era-typical context rather than an authenticity test; not every genuine piece is rayon.',
      'Silhouettes tend to be relaxed and flowing — bias-cut or draped shaping, midi and maxi lengths, sometimes with a waist tie or soft shaping seams. These are recurring tendencies, not guaranteed features.',
      'Prints are often large-scale florals or painterly, brushstroke-style abstracts in high-contrast, saturated colours — small ditsy or sharply geometric patterns are less common, though not absent.',
    ],
  ...
  },
  {
    ...
    metaDescription: 'Vintage Caroline Wells Collection — a little-documented American label found mostly on 1990s floral dresses and separates. Each a one-of-a-kind piece, hand-inspected.',
    origin: 'USA — late 20th century, mostly 1990s',
    intro: 'Caroline Wells Collection is a little-documented American womenswear label most commonly found on 1990s dresses and separates. Because company records are scarce, identification relies largely on surviving garments rather than published brand histories.',
    history: [
      'Caroline Wells Collection is most commonly encountered on garments dating from the 1990s. With so little published company history, the brand is best understood through the surviving pieces themselves rather than corporate records.',
      'Examples found on the vintage market are mainly dresses and separates — floral day dresses, rayon and rayon-blend pieces, coordinated separates and skirt sets. Most appear to have been made for the American department-store market and reflect mainstream women\'s fashion of the period.',
      'Because there is no documented label chronology, dating and identification rely primarily on the garment label, the fabric content, and the construction details.',
    ],
    identificationHeading: 'How to recognise vintage Caroline Wells',
    identification: [
      'Look for a label reading "Caroline Wells Collection" — a woven or printed brand tag typical of late-twentieth-century American apparel. The full wording, with "Collection", is the clearest identifier and helps distinguish it from similarly named labels.',
      'Rayon and rayon blends appear frequently among surviving dresses, alongside other lightweight woven dress fabrics — but fabric is not an authenticity test, and not every genuine piece is 100% rayon.',
      'Many examples carry floral or botanical prints in medium- to large-scale all-over patterns — a recurring characteristic rather than a way to identify the brand on its own.',
      'Common features include midi and maxi lengths, relaxed fits, button-front styles, and scoop, square or softly shaped necklines — recurring design traits rather than definitive identifiers.',
    ],
  ...
  },
  {
    ...
    history: [
      ...
      'For vintage collectors, the 1970s through the early 1990s account for many of the St Michael garments found on today\'s vintage market: tartan wool skirts, knitted floral cotton tops, smart blouses, and the printed dresses that filled British wardrobes during those decades.',
    ...
    identification: [
      ...
      'A second, smaller label inside often gives the M&S size and care instructions, sometimes with a style or product number — useful for cross-referencing.',
      ...
      'Wool, viscose, and cotton feature heavily across the era — check the composition label for the fabric story.',
      'Compared with many modern high-street garments, well-preserved St Michael pieces often display neat finishing, durable stitching and quality fabrics. Construction varies between garment types and decades, so no single sewing detail should be treated as an authenticity test.',
    ],
  ...
  },
  {
    ...
    history: [
      ...
      'Genuine vintage Viyella is valued for its soft handle, its tartans and checks, and a build quality that has kept pieces wearable for decades. As with most heritage British labels, the woven label and the fabric itself are the surest way to recognise it.',
    ],
    identificationHeading: 'How to recognise vintage Viyella',
    identification: [
  ...
  },
  {
    ...
    intro: 'Robbie Bee was an American dress label of the 1980s and 90s, producing the floral rayons, silky shifts, and easy department-store silhouettes typical of the period — part of the same cohort as Carole Little, Caroline Wells, and R&K Originals.',
    history: [
      ...
      'Its pieces favour the era\'s wearable silhouettes — florals, shifts, and midi dresses in rayon and silky fabrics — the kind of relaxed, printed dressing associated with the period.',
      'As with most of this cohort, genuine pieces are now firmly vintage, valued for their prints and drape rather than for a single signature design.',
    ],
    identificationHeading: 'How to recognise vintage Robbie Bee',
    identification: [
      'Look for the woven "Robbie Bee" label.',
      'Fabrics are typically rayon or silky synthetics with a fluid drape — recurring era context rather than an authenticity test.',
